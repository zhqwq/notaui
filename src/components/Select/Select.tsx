 ...
 */
const Select: FC<SelectProps> = ({ className, style, children, mode = 'single', disabled, defaultValue, onChange, onVisibleChange }) => {
  ...
  return (
    <div className={classes} style={style} ref={componentRef} onClick={handleClick}>
      <div className="select-selector">{mode === 'single' && <Input className="select-input" value={selectedValue} placeholder="请选择" />}</div>
